  ...
  <div class="statistics-page">
    ...
    <div class="charts-section animate-fade-in-up animation-delay-400">
      ...
      <div class="chart-card">
        ...
        <div class="chart-container">
          <v-chart class="chart" :option="detectionVolumeOption" autoresize />
        </div>
      </div>
      ...
      <div class="chart-card">
        ...
        <div class="chart-container">
          <v-chart class="chart" :option="accuracyTrendOption" autoresize />
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
      ...
      <div v-else-if="userStatistics?.recent_records?.length" class="space-y-3">
        <div v-for="record in userStatistics.recent_records" :key="record.id"
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
      ...
      <div v-else-if="userStatistics?.achievements?.length"
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div v-for="achievement in userStatistics.achievements" :key="achievement.id"
